...
$charge_amount = number_format($grand_total,2) * 100; //$ in Cents
$metadata = array(
  "cart_id"		=> $cart_id,
  "tax"			=> $tax,
  "sub_total"	=> $sub_total,
...
try {
  ...
  $items = json_decode($iresults['items'], true); //true to convert to array || false to convert to object
  ...
  $db->query("UPDATE cart SET paid = 1, cart_date = '$date' WHERE id = '$cart_id'");
  $db->query("INSERT INTO transactions
    (charge_id, cart_id, full_name, email, street, street2, city, state, zip_code, country, sub_total, grand_total, description, txn_type) VALUES
  ...
  setcookie(CART_COOKIE,'',1,"/",$domain,false); //false --> security
  //$cart_id = '';
  ...
  ?>
	...
	<div class="panel panel-success">
	  <div class="panel-body">
	    <p> Your cart has been successfully charged <?=money($grand_total);?>. You have been emailed a receipt. Please
