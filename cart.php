		  ...
		  <tbody>
		    <?php 
			  foreach($items as $item){
				...
				$productJson = json_decode($product['sizes'],true);
			...
			?>
				<tr>
				  ...
				  <td>
				    <button class="btn btn-xs btn-default" onclick="update_cart('removeOne','<?=$product['id'];?>','<?=$item['size'];?>');return false;">-</button>
				    <?=$item['quantity'];?>
					<?php if($item['quantity'] < $available): ?>
					<button class="btn btn-xs btn-default" onclick="update_cart('addOne','<?=$product['id'];?>','<?=$item['size'];?>');return false;">+</button>
				    <?php else: ?>
...
<button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#checkoutModal">
  <span class="glyphicon glyphicon-shopping-cart"></span> Check Out <span class="glyphicon glyphicon-forward"></span></button>
<!-- Modal -->
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="check_address();" id="next_button">Next <span class="glyphicon glyphicon-chevron-right"></span></button>
        <button type="button" class="btn btn-primary" onclick="back_address();" id="back_button" style="display:none;"><span class="glyphicon glyphicon-chevron-left"></span> Back</button>
        <button type="submit" class="btn btn-primary" id="checkout_button" style="display:none;">Check Out <span class="glyphicon glyphicon-forward"></span></button>
      </div>
	          </form>
    </div>
  </div>
...
<script>
  function back_address(){
	...
	jQuery('#checkoutModalLabel').text("Shipping Address");
  }
  ...
  jQuery.ajax({
	url: '/bs_ecommerce/admin/parsers/check_address.php',
	method: 'POST',
	data: data,
	success: function(data){
	  ...
	  if(data == 'passed'){
		...
		jQuery('#checkoutModalLabel').text("Enter Your Card Details");
	  }
	},
